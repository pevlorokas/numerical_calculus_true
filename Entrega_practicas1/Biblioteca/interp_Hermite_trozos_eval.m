...
## -*- texinfo -*-
## @deftypefn {} {@var{retval} =} interp_Hermite_trozos_eval (@var{input1}, @var{input2})
##
## @seealso{}
## @end deftypefn
...
##Una pequeña modificacion de polyinterpolador_a_trozos_eval 

function y = interp_Hermite_trozos_eval (t, matriz,nudos)
  y=[];
  m=length(nudos);
